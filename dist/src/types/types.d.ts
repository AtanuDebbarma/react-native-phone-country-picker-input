import { KeyboardTypeOptions, TextInputProps, StyleProp, ViewStyle, TextStyle, FlatListProps, ImageStyle } from 'react-native';
/**
 ...
 */
export type KeybordShouldPersists = boolean | 'handled' | 'always' | 'never' | undefined;
/**
