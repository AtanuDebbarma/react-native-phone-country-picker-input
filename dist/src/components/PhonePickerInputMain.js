...
exports.PhonePickerInputMain = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_native_1 = require("react-native");
const react_1 = require("react");
const CountryPickerModal_1 = require("./CountryPickerModal");
/**
...
customStyles, // Style overrides for all subcomponents
    ...
    const handleSelectCountry = (country) => {
        ...
        onSelectCountry === null || onSelectCountry === void 0 ? void 0 : onSelectCountry(country);
    };
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: [styles.mainInputContainer, customStyles === null || customStyles === void 0 ? void 0 : customStyles.mainInputContainer], children: [(0, jsx_runtime_1.jsxs)(react_native_1.Pressable, { style: ({ pressed }) => [
                    styles.flagPickerContainer,
                    customStyles === null || customStyles === void 0 ? void 0 : customStyles.flagPickerContainer,
                    pressed && ((customStyles === null || customStyles === void 0 ? void 0 : customStyles.customPressedStyle) || styles.pressed),
                ], onPress: handleModal, accessible: true, accessibilityLabel: `Selected country: ${selectedCountry.name}. Tap to change country`, children: [(0, jsx_runtime_1.jsx)(react_native_1.Text, { style: [styles.flagStyle, customStyles === null || customStyles === void 0 ? void 0 : customStyles.flagStyle], children: selectedCountry.flag }), !customArrowIconComponent ? ((0, jsx_runtime_1.jsx)(react_native_1.Image, { source: require('../assets/caretdown.png'), style: [styles.downArrowIcon, customStyles === null || customStyles === void 0 ? void 0 : customStyles.downArrowIcon] })) : (customArrowIconComponent), (0, jsx_runtime_1.jsx)(react_native_1.Text, { style: [styles.countryCodeText, customStyles === null || customStyles === void 0 ? void 0 : customStyles.countryCodeText], children: selectedCountry.dialCode })] }), !disableTextInput && ((0, jsx_runtime_1.jsx)(react_native_1.TextInput, Object.assign({ style: [styles.phoneTextInput, customStyles === null || customStyles === void 0 ? void 0 : customStyles.phoneTextInputStyle], keyboardType: keyboardType, placeholder: defaultplaceholder, value: phoneValue, onChangeText: onPhoneNumberValueChange }, customTextInputProps))), !customModalComponent ? ((0, jsx_runtime_1.jsx)(CountryPickerModal_1.CountryPickerModal, { modalVisible: modalVisible, setModalVisible: setModalVisible, openCountryModal: openCountryModal, customStyles: customStyles, otherFlatListProps: otherFlatListProps, searchIcon: searchIcon, countrySearchPlaceholder: countrySearchPlaceholder, otherCountrySearchTextInputProps: otherCountrySearchTextInputProps, setSelectedCountry: handleSelectCountry })) : (customModalComponent)] }));
};
exports.PhonePickerInputMain = PhonePickerInputMain;
/**
